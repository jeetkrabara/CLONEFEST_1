...
The creator enters a secret or uploads a file.
The client generates the required encryption keys.
The content is encrypted locally.
Viewer-specific key material is created where required.
Only encrypted information is sent to the backend.
The backend applies the configured access policies.
...
Live Demo:
https://clonefest-1-git-main-srscd.vercel.app/securebin-frontend.html
